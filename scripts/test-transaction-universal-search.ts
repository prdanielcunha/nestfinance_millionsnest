...
assert.ok(searchHandler.includes('loadAllocations('));
assert.ok(searchHandler.includes('categoryNames'));
assert.ok(searchHandler.includes('fundNames'));
assert.ok(searchHandler.includes('costCenterIds'));
...
assert.ok(page.includes('parseTransactionNaturalQuery(normalizedSearchQuery)'));
assert.ok(page.includes('naturalSearch.residualQuery'));
assert.ok(page.includes('searchTransactions(\n          effectiveResidualQuery,'));
assert.ok(page.includes('const naturalCategory = useMemo'));
assert.ok(page.includes('categoryIdFilter || naturalCategory?.id'));
