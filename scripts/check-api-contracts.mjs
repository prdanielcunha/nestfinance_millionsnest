...
export const GATEWAY_CONTRACTS = [
  ...
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'transaction-search', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'transaction-search-preview', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'transaction-search-apply', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'transaction-search-verify', exposure: 'gateway' },
  ...
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'count-sessions-discard', exposure: 'gateway' },
  ...
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'count-sessions-join-second-count', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'count-sessions-refresh-second-invite', exposure: 'gateway' },
  ...
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'count-free-form-captures-start', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'count-free-form-captures-finalize', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'count-free-form-captures-extract-candidates', exposure: 'gateway' },
  ...
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'universal-evidence-preview', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'universal-evidence-pdf-inspect', exposure: 'gateway' },
  ...
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'voice-transcription-create', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'intelligence-signals-summary', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'intelligence-corrections-save', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'intelligence-corrections-list', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'intelligence-corrections-remove', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'intelligence-engine-summary', exposure: 'gateway' },
  ...
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'reconciliation-exception-justify', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'reconciliation-reverse', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'reconciliation-progress', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'audit-list', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'audit-fact-projection-preview', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'audit-fact-projection-apply', exposure: 'gateway' },
  { method: 'POST', gateway: '/api/finance-gateway', operation: 'audit-fact-projection-verify', exposure: 'gateway' },
