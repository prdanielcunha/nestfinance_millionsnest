...
- I1 valida deterministicamente limite de 10 MB, assinatura MIME, SHA-256 e dimensões/orientação básica de imagens. Não executa OCR, IA, classificação ou qualquer mutação contábil.
