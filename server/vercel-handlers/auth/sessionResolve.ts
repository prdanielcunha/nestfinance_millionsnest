  ...
  try {
    ...
    if (resolution.granted) {
      ...
      return res.status(200).json({
        ...
        systemRole: resolution.systemRole,
        organizationRole: resolution.organizationRole,
        roles: resolution.roles,
        permissions: resolution.permissions,
        scopes: resolution.scopes,
        // Compatibility for the current frontend; canonical authorization data is permissions/scopes.
