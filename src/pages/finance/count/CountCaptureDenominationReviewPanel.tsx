...
import { Calculator, CheckCircle2, ScanText } from 'lucide-react';
...
export function CountCaptureDenominationReviewPanel({ capture, organizationId, financeEntityId, language, canEdit, onUpdated }: {
  ...
  useEffect(() => {
    ...
    setRows(next);
    setSaved(Boolean(capture.denominationReview?.fields?.length));
