...
const COPY: Record<Language, BalanceCopy> = {
  PT: {
    ...
    accessDeniedBody: 'Seu perfil não pode visualizar a área de conciliação financeira desta igreja.',
    errorTitle: 'Não foi possível verificar a conciliação',
    ...
    open: 'Abrir',
    trustTitle: 'Conciliação sem atalhos perigosos',
