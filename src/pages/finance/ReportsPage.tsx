...
const COPY: Record<Language, ReportsCopy> = {
  PT: {
    ...
    draft: 'Rascunhos',
    review: 'Em revisão',
    approved: 'Aguardando postagem',
    postedLabel: 'Postadas',
    matched: 'Conferidas',
    divergent: 'Divergentes',
    incomplete: 'Em andamento',
    reviewed: 'Conferidos',
    waitingReview: 'Para conferir',
    ...
    blockerLabels: {
      ...
      transactions_waiting_posting: 'Há movimentações aprovadas que ainda não foram postadas.',
  ...
  EN: {
    ...
    blockerLabels: {
      ...
      transactions_waiting_posting: 'Some approved transactions have not been posted yet.',
  ...
  ES: {
    ...
    draft: 'Borradores',
    review: 'En revisión',
    approved: 'Esperando contabilización',
    postedLabel: 'Contabilizadas',
    matched: 'Comprobados',
    divergent: 'Divergentes',
    incomplete: 'En curso',
    reviewed: 'Revisados',
    ...
    blockerLabels: {
      ...
      transactions_waiting_posting: 'Hay movimientos aprobados que aún no fueron contabilizados.',
