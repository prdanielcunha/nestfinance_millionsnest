...
const SIMPLE_MODE_COPY = {
  PT: {
    ...
    freeFormTitle: 'Fotografar meu papel',
    freeFormBody: 'Já anotou em caderno ou folha comum? Fotografe como está. O NestFinance tenta localizar os quatro totais e você confere antes de usar.',
    freeFormAction: 'Criar contagem e fotografar',
    filledSheet: 'Tenho uma Folha Count oficial preenchida',
    filledSheetBody: 'Use esta opção quando a folha foi gerada pelo NestFinance e tem QR/referência.',
    helpOpen: 'Preciso de ajuda',
    helpClose: 'Fechar ajuda',
    helpTitle: 'Como funciona a contagem',
    helpBody: 'Escolha como você quer contar, informe o culto e a data, confira os valores e só então avance. Nada altera saldo automaticamente.',
  },
  EN: {
    ...
    freeFormTitle: 'Photograph my paper',
    freeFormBody: 'Already wrote it in a notebook or plain sheet? Photograph it as-is. NestFinance looks for the four totals and you verify them before use.',
    freeFormAction: 'Create count and photograph',
    filledSheet: 'I have an official completed Count Sheet',
    filledSheetBody: 'Use this when the sheet was generated by NestFinance and has its QR/reference.',
    helpOpen: 'I need help',
    helpClose: 'Close help',
    helpTitle: 'How counting works',
    helpBody: 'Choose how you want to count, enter the service and date, check the values, and only then continue. Nothing changes balances automatically.',
  },
  ES: {
    ...
    freeFormTitle: 'Fotografiar mi papel',
    freeFormBody: '¿Ya lo anotaste en un cuaderno u hoja común? Fotografíalo tal como está. NestFinance busca los cuatro totales y tú los revisas antes de usarlos.',
    freeFormAction: 'Crear conteo y fotografiar',
    filledSheet: 'Tengo una Hoja Count oficial completada',
    filledSheetBody: 'Usa esta opción cuando la hoja fue generada por NestFinance y tiene QR/referencia.',
    helpOpen: 'Necesito ayuda',
    helpClose: 'Cerrar ayuda',
    helpTitle: 'Cómo funciona el conteo',
    helpBody: 'Elige cómo quieres contar, informa el culto y la fecha, revisa los valores y solo entonces continúa. Nada cambia saldos automáticamente.',
  },
} as const;
