...
export const TRANSACTION_DETAIL_OVERVIEW_COPY: Record<Language, TransactionDetailOverviewCopy> = {
  PT: {
    ...
    statuses: {
      ...
      ready_for_review: 'Aguardando conferência',
      approved_for_posting: 'Conferida — aguardando lançamento',
      posted: 'Lançada no financeiro',
      reversed: 'Revertida',
    ...
    approvedTitle: 'Conferida — aguardando lançamento',
    approvedBody: 'Os dados foram conferidos, mas ainda não entraram no saldo contábil. O lançamento real permanece bloqueado até a certificação.',
    advancedVerification: 'Abrir verificação avançada',
    postedTitle: 'Lançada no financeiro',
    postedBody: 'Esta movimentação foi registrada no razão financeiro. Confira o vínculo com a conta e a conciliação quando aplicável.',
  ...
  EN: {
    ...
    statuses: {
      ...
      approved_for_posting: 'Checked — waiting for posting',
    ...
    approvedTitle: 'Checked — waiting for posting',
    approvedBody: 'The information was checked, but it has not entered the accounting balance. Real posting remains blocked until certification.',
    advancedVerification: 'Open advanced verification',
    postedTitle: 'Posted to finance',
    postedBody: 'This transaction was recorded in the financial ledger. Review the account effect and bank match when applicable.',
  ...
  ES: {
    ...
    statuses: {
      ...
      approved_for_posting: 'Revisado — esperando registro',
      posted: 'Registrado en finanzas',
      reversed: 'Revertido',
    ...
    approvedTitle: 'Revisado — esperando registro',
    approvedBody: 'Los datos fueron revisados, pero todavía no entraron en el saldo contable. El registro real permanece bloqueado hasta la certificación.',
    advancedVerification: 'Abrir verificación avanzada',
    postedTitle: 'Registrado en finanzas',
    postedBody: 'Este movimiento fue registrado en el libro financiero. Revisa el efecto en la cuenta y la conciliación cuando corresponda.',
